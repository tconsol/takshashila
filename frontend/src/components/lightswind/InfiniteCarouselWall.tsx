...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    avatar: 'PS',
    text: 'brainbaseedumade finding the right tutor effortless. I went from failing Math to scoring 94% in one semester. My confidence has completely transformed!',
    rating: 5,
    verified: true,
  ...
  },
  {
    ...
    avatar: 'KN',
    text: "Physics used to be my nightmare. My tutor on brainbaseeduexplained every concept with real examples. Scored 89 in boards my parents cried happy tears!",
    rating: 5,
    verified: true,
  ...
  },
  {
    ...
    avatar: 'SP',
    text: 'I joined brainbaseeduas a part-time tutor. Within two months I had a full schedule and tripled my income compared to offline coaching.',
    rating: 5,
    verified: true,
