...
const NAV_ITEMS: Record<Role, NavItem[]> = {
  SUPER_ADMIN: [
    ...
    { label: 'Curriculum',  href: '/dashboard/super-admin/curriculum', icon: GraduationCap },
    { label: 'Skill Programs', href: '/dashboard/super-admin/programs', icon: Sparkles },
  ...
  ADMIN: [
    ...
    { label: 'Skill Programs', href: '/dashboard/admin/programs', icon: Sparkles },
