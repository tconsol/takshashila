...
const KB_ENTRIES: KB[] = [
  ...
  { keys: ['subject', 'what can i learn', 'curricula', 'topics', 'which subjects'], a: 'We offer 100+ subjects  Maths, Physics, Coding, English, Chemistry, Biology, Public Speaking, Computer Science and more, across all grade levels.' },
