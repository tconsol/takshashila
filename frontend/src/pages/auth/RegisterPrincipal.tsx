    ...
    <div className="space-y-7">
      <div>
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Join as Principal</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">Manage your institution on Brainbase Edu</p>
          </div>
        </div>
      </div>
