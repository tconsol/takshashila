    ...
    <div className="space-y-7">
      <div>
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border-2.5 border-clay-ink bg-clay-mint shadow-clay-sm">
            <Award className="h-5 w-5 text-clay-ink" />
          </div>
          <div>
            <h1 className="text-2xl font-extrabold text-clay-ink dark:text-white">Join as Principal</h1>
            <p className="text-sm font-semibold text-clay-ink/60 dark:text-gray-400">Manage your institution on Takshashila</p>
          </div>
        </div>
      </div>
